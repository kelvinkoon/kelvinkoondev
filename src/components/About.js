      ...
      <div>
        <div className="left">
          ...
          <p>
            ...
            competitive gaming. I also help run the ECESS mentorship 
			program for 2nd year ECE students.
          </p>
        </div>
        <div className="right">
          ...
          <div className="external">
            <p>
              <a
                href="https://drive.google.com/file/d/1OFBVObZusfkiCQxaYmrCWqPTCW06K0dB/view?usp=sharing"
                target="_blank"
